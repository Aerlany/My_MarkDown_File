...
所有实际数据类型，不管是整型、浮点型、字符型，还是其他的数据类型，对应指针的值的类型都是一样的，都是**一个代表内存地址的长的十六进制数**。
...
```c
/*************************************************************************
    > File Name: 02-预处理运算符.c
    > Author: Aerlany
    > Mail: 1243535201@qq.com
    > Created Time: Thu 10 Nov 2022 11:16:45 PM CST
 ************************************************************************/

#include <stdio.h>

#define message_for(a, b) printf(#a " and " #b ":we are lover!!")

int main() {
  message_for(Aerlany, Bill);
  return 0;
}
```

```sh
Aerlany and Bill:we are lover!!
```
...
```c
/*************************************************************************
    > File Name: 03-预处理运算符_##.c
    > Author: Aerlany
    > Mail: 1243535201@qq.com
    > Created Time: Thu 10 Nov 2022 11:28:01 PM CST
 ************************************************************************/

#include <stdio.h>

#define PrintMessage(a) printf("Message " #a ": %d", Message##a)
...
```c
/*************************************************************************
    > File Name: 04-参数化的宏.c
    > Author: Aerlany
    > Mail: 1243535201@qq.com
    > Created Time: Thu 10 Nov 2022 11:38:00 PM CST
 ************************************************************************/
...
int main() {
  ...
  printf("MaxNumber is %d", MaxNumber(20, 30));
...
输出错误的方法  **errno、perror() 和 strerror()**
...
/*************************************************************************
    ...
    > Author: Aerlany
    > Mail: 1243535201@qq.com
    > Created Time: Fri 11 Nov 2022 12:08:35 AM CST
 ************************************************************************/
...
```sh
错误号: 2
通过 perror 输出当前错误: No such file or directory
...
```c
/*************************************************************************
    > File Name: 02-被零除时错误.c
    > Author: Aerlany
    > Mail: 1243535201@qq.com
    > Created Time: Fri 11 Nov 2022 08:04:02 PM CST
 ************************************************************************/
#include <stdio.h>
#include <stdlib.h>
...
```c
/*************************************************************************
    > File Name: 01-factorial.c
    > Author: Aerlany
    > Mail: 1243535201@qq.com
    > Created Time: Fri 11 Nov 2022 08:15:11 PM CST
 ************************************************************************/
...
```c
/*************************************************************************
    > File Name: 02-fibonaci.c
    > Author: Aerlany
    > Mail: 1243535201@qq.com
    > Created Time: Fri 11 Nov 2022 08:26:27 PM CST
 ************************************************************************/
...
您希望函数带有可变数量的参数，而不是预定义数量的参数。C 语言为这种情况提供了一个解决方案，它允许您定义一个函数，能根据具体的需求接受可变数量的参数。
...
/*************************************************************************
    ...
    > Author: Aerlany
    > Mail: 1243535201@qq.com
    > Created Time: Fri 11 Nov 2022 08:50:04 PM CST
 ************************************************************************/
...
/*************************************************************************
    ...
    > Author: Aerlany
    > Mail: 1243535201@qq.com
    > Created Time: Sat 12 Nov 2022 03:10:17 PM CST
 ************************************************************************/
...
int main() {
  ...
  if (description == NULL) {
    ...
    strcpy(description, "Every day I remind myself that my inner and outer "
                        "life are based on the labors of other men");
  }
  printf("%s\n", description);
}
```
...
int main() {
  char *description;
  description = (char *)calloc(10, sizeof(char));
  if (description == NULL) {
    printf("储存空间分配错误!!");
  } else {
